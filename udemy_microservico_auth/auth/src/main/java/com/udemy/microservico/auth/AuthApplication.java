package com.udemy.microservico.auth;

import com.udemy.microservico.auth.entity.Permission;
import com.udemy.microservico.auth.entity.User;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUsername("coradi");
		if (find == null) {
